  ...
  return (
    <div className="space-y-3.5">
      <div className="px-0.5">
        <h2 className="text-[19px] leading-tight font-semibold tracking-tight">Protected Chats</h2>
        ...
        <section className="space-y-1.5">
          ...
          <Card className="gap-0 px-3 py-3 shadow-none border-gray-400 rounded-md">
            <div className="flex items-center gap-2">
              ...
              {currentChat ? (
                <Badge variant="secondary" className="bg-tint-success! text-tint-success-foreground!">
                  <ShieldCheck />
                  Protected
                </Badge>
              ) : null}
            ...
            {currentChat ? (
              <Button variant="outline" size="sm" className="mt-2.5 w-full" onClick={() => onOpenChat(currentChat.id)}>
                Open its settings
              </Button>
            ) : (
        ...
        {chats.length === 0 ? (
          <Card className="gap-0 px-3 py-4 text-center shadow-none border-gray-400">
            ...
            <p className="mx-auto mt-1 max-w-[17rem] text-[11.5px] leading-snug text-muted-foreground">
              Open a Messenger conversation and protect it to hide its call and group buttons.
            </p>
          </Card>
        ) : (
